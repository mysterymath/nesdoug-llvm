...
static const unsigned char level_1_coins[] = {
    // clang-format off
...
static const unsigned char level_2_coins[] = {
    // clang-format off
...
static const unsigned char level_3_coins[] = {
    // clang-format off
...
const unsigned char *const Coins_list[] = {level_1_coins, level_2_coins,
                                           level_3_coins};
...
static const unsigned char level_2_enemies[] = {
    // clang-format off
...
static const unsigned char level_3_enemies[] = {
    // clang-format off
...
const unsigned char *const Enemy_list[] = {level_1_enemies, level_2_enemies,
                                           level_3_enemies};
...
const unsigned char *const Levels_list[] = {
    Level1_0, Level1_1, Level1_2, Level1_3, Level1_4, Level1_5,
    Level1_6, Level1_7, Level2_0, Level2_1, Level2_2, Level2_3,
    Level2_4, Level2_5, Level2_6, Level2_7, Level3_0, Level3_1,
    Level3_2, Level3_3, Level3_4, Level3_5, Level3_6, Level3_7};

const unsigned char Level_offsets[] = {0, 8, 16};
